...
class WfRed(object):
    ...
    def Slownoise_Smooth(self,data,ite):
        ...
        nsamples = 700#700 #determines width of smoothing gaussian (/5) = sigma of gauss 
    ...
    def Fastnoise_Smooth(self,filtered_signal_1):
        ...
        sig_smooth_ns = 2#4 # Depends on pulse shape... 
    ...
    def PulseClean(self,data,pulse_pos_clean):
        ...
        returns: List of pulse heights and areas
        """
        wl = 10#2 # in ns, so 2.5 samples == 1 ns, 10 ns = 25 samples #10?
        wr = 10#4 #15?
    ...
    def Plot(self,pulse_h,pulse_h_c,pulse_a,pulse_a_c,ppc):
        ...
        ax1.hist(pulse_h,bins = nbins,color='grey',label='Height',histtype='step')
    ...
    def Reduce_Data(self):
        ...
        for ite in range(0,calcseg):    
            ...
            '''
            plt.figure()
            plt.plot(time,self.signal1,c='lightblue')
            plt.plot(time,signal2,c='k')
            plt.show()
            '''
